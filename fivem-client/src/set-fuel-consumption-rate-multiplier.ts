...
 * @param {number} multiplier Global fuel consumption multiplier. If negative  0 will be used instead.
 */
export function setFuelConsumptionRateMultiplier(multiplier: number): void {
	const setFuelConsumptionRateMultiplier_result = Citizen.invokeNative<void>('0x845F3E5C', multiplier);
	return setFuelConsumptionRateMultiplier_result;
}