 ...
 * 
 * ------------------------------------------------------------------
 * @param {IntRef} blipId [Ref]
 */
export function removeBlip(blipId: IntRef /* ptr */): void {
	const removeBlip_result = Citizen.invokeNative<void>('0xFE54B8568B2ABD12', blipId.dataView);
