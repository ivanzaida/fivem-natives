export enum EPedConfigFlags {
	...
	UsingScenario = 194, // Set when the ped is using a scenario. Call CPed
	...
	AvoidanceIgnoreAll = 202, // This ped won't steer around anyone
	AvoidanceIgnoredByAll = 203, // Other peds won't steer around this ped
	AvoidanceIgnoreGroup1 = 204, // This ped won't steer around peds marked group 1
	AvoidanceMemberOfGroup1 = 205, // This ped is marked as a member of avoidance group 1
	...
	TeleportToLeaderVehicle = 268, // If set, teleport if ped is not in the leader's vehicle before TaskEnterVehicle
	AvoidanceIgnoreWeirdPedBuffer = 269, // Don't give weird peds extra buffer
	...
	WalkAlongsideLeaderWhenClose = 274, // This ped will walk alongside group leader if they are the first member of the leader's pedgroup, they are close enough to the leader, and the pedgroup's formation is set up to allow this (such as in the default CPedFormationTypes
	...
	EquippedAmbientLoadOutWeapon = 278, // This is set to prevent a ped from holstering a loadout weapon equipped during CPedPopulation
	...
	DisableGoToWritheWhenInjured = 281, // If set, CPed
	...
	ThrowingGrenadeWhileAiming = 354, // Set true in CTaskAimGunOnFoot
	...
	SwitchingCharactersInFirstPerson = 387, // True we switch a character in first person mode (in CGameWorld
	IsClimbingLadder = 388, // True when the ped is climbing a ladder
	HasBareFeet = 389, // Set when the ped has no shoes
	UnusedReplaceMe_2 = 390,
	...
	BlockDroppingHealthSnacksOnDeath = 392, // Set by script to prevent peds from dropping snack health pickups on death (in CPed
	...
	DontLeaveVehicleIfLeaderNotInVehicle = 402, // Supresses exit vehicle task being created in CEventLeaderExitedCarAsDriver
	...
	UseNormalExplosionDamageWhenBlownUpInVehicle = 407, // If this is set, the ped won't be instantly killed if vehicle is blown up (from CAutomobile
	...
	LawPedsCanFleeFromNonWantedPlayer = 411, // Allows law ped to flee even if ped is not wanted and CWanted
